      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12">
            ...
            <form action="/menu/kegiatan/{{ $kegiatan->id }}" method="post" >
              @method('put')
              @csrf
              <div class="row">
                <div class="col-md-6">     
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $kegiatan->name_kegiatan }}" class="form-control pt-1 @error('name_kegiatan') is-invalid @enderror" id="name_kegiatan" aria-describedby="name_kegiatan"name="name_kegiatan"/>
