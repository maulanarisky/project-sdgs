              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control pt-1 @error('kode_pojk') is-invalid @enderror" name="kode_pojk" />
                ...
                <div class="col-md-6">     
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control pt-1" name="kegiatan_pojk" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control pt-1 @error('no_urut') is-invalid @enderror" name="no_urut" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control pt-1 @error('kegiatan') is-invalid @enderror" name="kegiatan" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text"  class="form-control pt-1 @error('indikator_capaian') is-invalid @enderror" name="indikator_capaian" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control pt-1 @error('satuan') is-invalid @enderror" name="satuan" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control pt-1 @error('target') is-invalid @enderror" name="target" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control pt-1 @error('capaian') is-invalid @enderror" name="capaian" />
