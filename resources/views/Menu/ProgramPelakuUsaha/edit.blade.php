      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12">
            ...
            <form action="/menu/umkm/{{ $umkm->id }}" method="post" >
              @method('put')
              @csrf
              <div class="row">
                <div class="col-md-6">     
                    <div class="form-group">
                        ...
                        <select class="form-control" name="indikator_id" id="indikator_id">
                          @foreach ($indikators as $indikator)
                            @if(old('indikator_id', $umkm->indikator_id) == $indikator->id)    
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $umkm->kode_pojk }}" class="form-control pt-1 @error('kode_pojk') is-invalid @enderror" name="kode_pojk" />
                ...
                <div class="col-md-6">     
                  <div class="form-group">
                      ...
                      <input type="text" value="{{ $umkm->kegiatan_pojk }}" class="form-control pt-1" name="kegiatan_pojk" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="number" value="{{ $umkm->no_urut }}" class="form-control pt-1 @error('no_urut') is-invalid @enderror" name="no_urut" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $umkm->kegiatan }}" class="form-control pt-1 @error('kegiatan') is-invalid @enderror" name="kegiatan" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $umkm->indikator_capaian }}" class="form-control pt-1 @error('indikator_capaian') is-invalid @enderror" name="indikator_capaian" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $umkm->satuan }}" class="form-control pt-1 @error('satuan') is-invalid @enderror" name="satuan" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $umkm->target }}" class="form-control pt-1 @error('target') is-invalid @enderror" name="target" />
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ $umkm->capaian }}" class="form-control pt-1 @error('capaian') is-invalid @enderror" name="capaian" />
