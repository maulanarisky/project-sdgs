...
<?php $__env->startSection('container'); ?>
 ...
 <div class="container-fluid">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800 text-center">Form 2A <?php echo e(Auth::user()->name); ?></h1>
            ...
            <!-- DataTales Example -->
             ...
             <div class="card-header py-3">
                  ...
                  <?php if(Auth::user()->role_id == 1): ?> 
                    <a href="/form2a-export/<?php echo e($tahunSinggle->id); ?>" class="btn btn-success">Excel</a>
